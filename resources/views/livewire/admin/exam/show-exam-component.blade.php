                    ...
                    @foreach ($exams as $exam )
                      <tr>
                        ...
                        <td>
                            ...
                            <a  class="btn btn-danger manual" href="{{ route("add_question_pargraph",['id_exam'=>$exam->id]) }}" >add questions paragraph</a>
                            <a  class="btn btn-danger manual" href="{{ route("add_block_question",['id_exam'=>$exam->id]) }}" >add block</a>
