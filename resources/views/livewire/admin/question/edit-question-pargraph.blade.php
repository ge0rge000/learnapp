        ...
        <div class="card">
          ...
          <div class="card-content collapse show">
            <div class="card-body">
              ...
              <form class="form" wire:submit.prevent="edit_question">
                <div class="form-body">
                  ...
                  <div class="row">
                                ...
                                <textarea type="text" input="description" id="summernote" class="form-control summernote">{{ $question }}</textarea>
                                      ...
                                      <div class="col-md-12">
                                        <div class="form-group">
                                          <label for="projectinput1">answer</label>
                                          <input type="text" id="units" class="form-control" placeholder="answer "
                                          name="fname" wire:model="answer">
                                        </div>
                                      </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                          <label for="projectinput1">Mark Question</label>
                          <input type="number" id="projectinput1" class="form-control" placeholder="Mark Question"
