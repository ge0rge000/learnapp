        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="{{ route("home_admin") }}">
              ...
              <h3 class="brand-text">Le Chef</h3>
            </a>
          </li>
            ...
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                <span class="mr-1">Hello,
                  <span class="user-name text-bold-700">Le CHEF</span>
                </span>
      ...
      <div class="main-menu menu-static menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="main-menu-content">
          <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="index.html"><i class="la la-file-video-o"></i><span class="menu-title" data-i18n="nav.dash.main">Videos</span></a>
                <ul class="menu-content">
            ...
            <li class=" nav-item"><a href="index.html"><i class="lla la-files-o"></i><span class="menu-title" data-i18n="nav.dash.main">Exams</span></a>
                <ul class="menu-content">
            ...
            <li class=" nav-item"><a href="index.html"><i class="la la-sliders"></i><span class="menu-title" data-i18n="nav.dash.main">Slider</span></a>
                <ul class="menu-content">
                  <?php
                          $url="http://127.0.0.1:8000";
                  ?>
